...
public class AutoOpBlueCloseStartDaniel extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            // Step 5: Turn right 45 degrees to face balls (Alex behavior)
            ...
            // Step 9: Drive backward to clear the area
            ...
            // Step 10: Scan for AprilTag and approach for second shot
            currentStatus = "Scanning for AprilTag";
            updateStatusDisplay();
            ...
            // Step 11: Shoot for 8 seconds (second pass)
            currentStatus = "Shooting 8 sec";
            updateStatusDisplay();
            shootSequence(8.0);
            currentStatus = "Shoot Complete";
