...
@Autonomous(name = "Red Close Start 12/2")
public class AutoOpRedCloseStart extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("=== RED CLOSE START ===");
        telemetry.addLine();
        ...
        telemetry.addLine("  6. Turn Right 45°");
        ...
        telemetry.addLine("  11. Strafe Right 40\"");
        telemetry.addLine("  12. Turn Right 45° to Park");
        telemetry.addLine();
        ...
        if (opModeIsActive()) {
            ...
            // Step 2: Quick reverse mode to prepare
            ...
            // Step 6: Turn right 45 degrees to face the balls
            ...
            // Step 11: Strafe right 40 inches to park position
            ...
            // Step 12: Turn right 45 degrees to final park orientation
            currentStatus = "Turn Right 45°";
            updateStatusDisplay();
            turnToHeading(45, TURN_SPEED, 3.0);
            currentStatus = "Turn Complete";
