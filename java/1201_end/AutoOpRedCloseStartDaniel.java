...
public class AutoOpRedCloseStartDaniel extends AutoOpBase {
    ...
    /**
     * Return the AprilTag ID for Red alliance
     */
    @Override
    protected int getDesiredTagId() {
        return 24;  // Red alliance AprilTag
    }
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("=== RAY RED AUTO OP 2 ===");
        telemetry.addLine();
        ...
        telemetry.addLine("  9. Strafe Right 40\"");
        telemetry.addLine(" 10. Turn Right 45°");
        telemetry.addLine();
        ...
        if (opModeIsActive()) {
            ...
            // Step 4: Turn right 45 degrees to face balls
            // Follow Blue's second-pass approach but mirrored for Red (turn right instead of left)
