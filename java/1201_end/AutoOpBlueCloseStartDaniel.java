...
@Autonomous(name = "AutoOp Blue close start daniel 12/6")
public class AutoOpBlueCloseStartDaniel extends AutoOpBase {
    ...
    /**
     * Return the AprilTag ID for Blue alliance
     */
    @Override
    protected int getDesiredTagId() {
        return 20;  // Blue alliance AprilTag
    }
    ...
    public void runOpMode() {
        ...
        // Initialize AprilTag vision (parent method with automatic exposure optimization)
        initAprilTag();
        ...
        telemetry.addLine("  5. Drive & Intake Balls");
        telemetry.addLine("  6. Drive Backward");
        telemetry.addLine("  7. Scan & Drive to AprilTag");
        telemetry.addLine("  8. Shoot (8 sec)");
        telemetry.addLine("  9. Strafe Left 40\"");
        telemetry.addLine(" 10. Turn Left 45°");
        telemetry.addLine();
        ...
        if (opModeIsActive()) {
            ...
            // Follow Alex's second-pass approach but keep the CLOSE starting move
            // (We already completed the first shooting pass earlier)
            ...
            // Step 7: Scan for AprilTag and approach for second shot
            currentStatus = "Scanning for AprilTag";
            updateStatusDisplay();
    ...
    private void initHardware() {
        // Initialize drive motors and IMU (using parent class variables)
        ...
        // Initialize accessory motors (child-specific)
        ...
        // Initialize pose tracking encoders (using parent class variables)
    ...
    // ==================== AprilTag Functions ====================
    // All AprilTag functions (initAprilTag, setManualExposure, detectAprilTag, 
    // scanForAprilTag, updateStatusDisplay) are inherited from AutoOpBase
    // and provide advanced exposure optimization with automatic retry logic
