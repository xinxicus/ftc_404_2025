...
public class AlexRedFarStart extends AutoOpBase {
    ...
    /**
     * Red alliance uses AprilTag ID 24
     */
    @Override
    ...
    public void runOpMode() {
        ...
        // Initialize AprilTag vision (automatically sets default exposure)
        initAprilTag();
    ...
    // ==================== Shooter Control ====================
    // Note: AprilTag functions (initAprilTag, setManualExposure, detectAprilTag, scanForAprilTag, updateStatusDisplay)
    // are inherited from AutoOpBase parent class
