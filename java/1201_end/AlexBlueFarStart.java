...
public class AlexBlueFarStart extends AutoOpBase {
    ...
    /**
     * Blue alliance uses AprilTag ID 20
     */
    @Override
    ...
    public void runOpMode() {
        ...
        // Initialize AprilTag vision (parent handles default exposure automatically)
        initAprilTag();
        ...
        if (opModeIsActive()) {
            ...
            currentStatus = "Scanning for AprilTag";
            updateStatusDisplay();
            if (scanForAprilTag(45.0, false, 10.0)) { // Scan right first
                currentStatus = "Tag Found - Driving";
                updateStatusDisplay();
                driveToAprilTag(10.0);
                currentStatus = "AprilTag Complete";
            ...
            currentStatus = "Parking: Strafe Left 40\"";
            updateStatusDisplay();
