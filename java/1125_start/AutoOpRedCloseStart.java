...
@Autonomous(name="AutoOp Red close start 11/8")
public class AutoOpRedCloseStart extends AutoOpBase {
    // ---- Loading zone drive parameters ----
    private static final double MOTOR_WARM_UP_POWER = 0.1;
    ...
    protected int getDesiredTagId() {
        return 24;  // Red alliance AprilTag ID
    }
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("  5. Strafe Right 40\"");
        telemetry.addLine();
        ...
        if (opModeIsActive()) {
            ...
            updateStatusDisplay();
            driveDistance(30, 0, DRIVE_SPEED, 5.0);
    ...
    private void driveToAprilTag(double timeoutSeconds) {
        ...
        while (opModeIsActive() && timer.seconds() < timeoutSeconds) {
            ...
            if (!targetFound) {
                ...
                for (int attempt = 1; attempt <= 3 && opModeIsActive(); attempt++) {
